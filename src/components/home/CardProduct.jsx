...
export default function CardProduct({ product }) {
  return (
    <div className="group mx-auto flex max-h-[320px] min-h-[320px] min-w-[190px] max-w-[200px] cursor-pointer flex-col justify-center  overflow-hidden rounded-md border border-slate-200 duration-500 md:w-2/12 md:hover:scale-105 md:hover:shadow-lg">
