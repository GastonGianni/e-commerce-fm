...
export default function CardProduct({ product }) {
  return (
    <div className="group  flex min-h-[310px] min-w-[150px] max-w-[250px] cursor-pointer flex-col justify-center overflow-hidden border border-slate-200 duration-500   md:rounded-md md:hover:scale-105 md:hover:shadow-lg ">
