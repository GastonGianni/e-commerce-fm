...
export default function CardProduct({ product }) {
  return (
    <Link
      ...
      className="group flex min-h-[350px] min-w-[262px] max-w-[280px] cursor-pointer flex-col justify-center overflow-hidden border border-slate-200 bg-white duration-300 md:rounded-md md:hover:scale-105 md:hover:shadow-lg"
    >
