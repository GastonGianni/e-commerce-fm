    ...
    <section className="container mx-auto px-4 md:max-w-[520px] md:p-0 lg:m-0 ">
      ...
      <section className="font-bold lg:flex lg:gap-3">
        ...
        <div className="mb-3 lg:w-full">
          <button className="flex w-full items-center justify-center gap-2 rounded-lg bg-orange-personal py-4 text-white shadow-lg transition-all hover:bg-orange-400 ">
            <CartIcon fill="#fff" />
