      ...
      {isModalOpen && (
        <>
          <ModalProduct
            ...
            className="mx-auto hidden md:absolute md:top-1/2 md:left-1/2 md:z-10 md:grid md:min-w-[580px] md:max-w-[620px] md:-translate-y-1/2 md:-translate-x-1/2 md:grid-cols-4 md:gap-4"
          />
